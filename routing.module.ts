...
export const PURCHASERoutes: Routes = [
    ...
    { path: 'purchase-quotation', loadChildren: () => import('./purchase-order/purchase-order.module').then(m => m.PurchaseOrderPageModule), canActivate: [AuthGuard] },
    { path: 'purchase-quotation/:id', loadChildren: () => import('./purchase-order-detail/purchase-order-detail.module').then(m => m.PurchaseOrderDetailPageModule), canActivate: [AuthGuard] },
